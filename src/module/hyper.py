...
def process_control():
    ...
    if 'data_mode' in cfg['control']:
        ...
        cfg[tag]['local']['optimizer']['lr'] = 3e-2
        ...
        cfg[tag]['global']['optimizer']['optimizer_name'] = 'SGD'
        cfg[tag]['global']['optimizer']['lr'] = 1
        cfg[tag]['global']['optimizer']['momentum'] = 0
        cfg[tag]['global']['optimizer']['weight_decay'] = 0
        cfg[tag]['global']['optimizer']['nesterov'] = False
